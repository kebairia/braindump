...
we can use our ssh public-key to fetch and push our code from/to github repo
so instead of linking your remote repo the traditional way, we can use our ssh public key instead.
1) add your ssh public key to your github profile
