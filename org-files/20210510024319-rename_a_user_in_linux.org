...
#+filetags: :linux:unix:sysadmin:user:
...
- you can use the ~find~ command to look for all the files and directories with a specific *GID*, and change there group owner
  ...
  #+end_src
  [[file:img/change_username_linux/change_username_in_linux.png]]
...
- *NOTE*: if you want to exclude results in find output, check this [[id:dfc8ae11-718b-46c7-9858-284265816c79][note]]
